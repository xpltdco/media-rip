...
- [x] **T02: Build SSE endpoint with replay, disconnect cleanup, and job_removed broadcasting** `est:1h`
...
- [x] **T03: Add health endpoint, public config endpoint, and session-mode query layer** `est:45m`
